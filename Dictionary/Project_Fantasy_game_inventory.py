...
# Or not using the get() function and acessing the key(k) and value(k) in the foor loop
...
def displayInventory(invent):
    ...
    print('Inventory:')
    item_total = 0
    for k, v in invent.items():          #k is the key() 'rope',  v is the value() 1 . Remember item() is both
